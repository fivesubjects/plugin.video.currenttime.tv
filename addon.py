...
main_menu = ([['play', 'Прямой эфир', 'live', 'http://rfe-lh.akamaihd.net/i/rfe_tvmc5@383630/master.m3u8',
              ...
              ['last_vids_fldr', 'Час Тимура Олевского', 'olevski', '/z/20333.html',
               'Ежедневная телепередача \"Час Тимура Олевского\". Архив программ.\n'
              ...
              ['last_vids_fldr', 'Настоящее Время', 'nv', '/z/18657.html',
               'Ежедневная телепередача \"Настоящее Время\". Архив программ.'
               ],
              ['last_vids_fldr', 'Настоящее Время – Азия', 'nvasia', '/z/17642.html',
               'Ежедневная телепередача \"Настоящее Время – Азия\". Архив программ.'
               ],
              ['last_vids_fldr', 'Настоящее Время – Америка', 'nvamerica', '/z/20347.html',
               'Ежедневная телепередача \"Настоящее Время – Америка\". Архив программ.'
               ],
              ['last_vids_fldr', 'Смотри в оба', 'oba', '/z/20366.html',
               'Еженедельная передача \"Смотри в оба\". Архив программ.'
               ],
              ['last_vids_fldr', 'Итоги', 'itogi', '/z/17499.html',
               'Еженедельная итоговая телепередача \"Итоги\" (по субботам). Архив программ.'
               ],
              ['last_vids_fldr', 'Неделя', 'week', '/z/17498.html',
               'Еженедельная итоговая телепередача \"Неделя\" (по воскресеньям). Архив программ.'
               ],
              ['last_vids_fldr', 'Балтия. Неделя', 'baltia', '/z/20350.html',
               'Еженедельная итоговая передача \"Балтия. Неделя\" (по субботам). Архив программ.'
               ],
              ['last_vids_fldr', 'Бизнес-план', 'bisplan', '/z/20354.html',
               'Еженедельная передача \"Бизнес-план\". Архив программ.'
               ],
              ['last_vids_fldr', 'Неизвестная Россия', 'unknownrus', '/z/20331.html',
               'Цикл \"Неизвестная Россия\". Архив программ.'
               ]])
...
def img_link(name, type):
    ...
    image = os.path.join(ptv.getAddonInfo('path'), "images/"+name+'_'+type+ext)
    return image
